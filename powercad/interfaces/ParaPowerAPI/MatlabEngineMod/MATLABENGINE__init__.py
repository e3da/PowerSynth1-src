"""
Modified __init__.py file for the Matlab Engine for Python API
This file should replace the __init__.py in your virtual environment under:
venv/Lib/site-packages/matlab/engine/__init__.py
"""
...
_arch = "win64"
_bin_dir = matlab.MATLAB_BIN
_engine_dir = matlab.MATLAB_ENGINE_PYD
