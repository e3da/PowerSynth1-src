...
class Ui_CornerStitch_Dialog(object):
    def setupUi(self, CornerStitch_Dialog):
        ...
        self.txt_seed = QtGui.QLineEdit(self.groupBox)
        self.txt_seed.setObjectName("txt_seed")
        self.gridLayout_3.addWidget(self.txt_seed, 1, 1, 1, 1)
    ...
    def retranslateUi(self, CornerStitch_Dialog):
        ...
        self.label.setText(QtGui.QApplication.translate("CornerStitch_Dialog", "Seed", None, QtGui.QApplication.UnicodeUTF8))
