...
from powercad.design.module_data import gen_test_module_data,gen_test_module_data_kv
...
def make_test_setup2(f,directory):
    ...
    make_test_leads(symbols=sym_layout.all_sym, lead_type=sig_lead,
                    lead_id=['0007','0008'])  # Depends on the layout script you have, you can assign the lead object to a SYM-POINT using the id of the object
    make_test_bonds(symbols=sym_layout.all_sym, bond_type=signal_bw,
                    bond_id=['0004', '0005'], wire_spec=[1, 1])
    make_test_bonds(symbols=sym_layout.all_sym, bond_type=power_bw,
                    bond_id=['0006'], wire_spec=[1, 1])
    make_test_devices(symbols=sym_layout.all_sym,dev=dev_mos,dev_id=['0003'])  # Depends on the layout script you have, you can assign the device object to a SYM-POINT using the id of the object
    ...
    individual = [7.916632991588472, 4.061868513111297, 5.07407360537381, 6.030055430377637, 5.07407360537381, 5.07407360537381, 0.08730148686581662] # This one change depends on the number of design variables you have. This is the design vector basically
...
directory ='Layout//kelvin2.psc' # directory to layout script
